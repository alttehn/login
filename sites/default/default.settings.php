 ...
 *
 */
$drupal_hash_salt = '0E113-0O6-vR--U3Ed-PlVCR99FldKjvPnDPL1-eXo4';
...
/**
*      'database' => getenv("OPENSHIFT_EXTMYSQL_DB_NAME"),
 ...
 'serversdb' => 
  array (
    ...
    array (
      ...
      'database' => 'servers',
      'username' => getenv("OPENSHIFT_EXTMYSQL_DB_USERNAME"),
      'password' => getenv("OPENSHIFT_EXTMYSQL_DB_PASSWORD"),
      'host' => getenv("OPENSHIFT_EXTMYSQL_DB_HOST"),
      'port' => getenv("OPENSHIFT_EXTMYSQL_DB_PORT"),
      'driver' => 'mysql',
      'prefix' => '',
    ),
  ),
